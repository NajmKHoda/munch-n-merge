                            ...
                            <div className="flex items-center">
                                <div className="relative user-dropdown">
                                    <button 
                                        ...
                                        className="flex items-center gap-1 px-3 py-1.5 rounded-md text-gray-600 hover:text-indigo-600 hover:bg-indigo-50 transition-all duration-200 focus:outline-none"
                                    >
